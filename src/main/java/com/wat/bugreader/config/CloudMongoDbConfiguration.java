package com.wat.bugreader.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.wat.bugreader.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.wat.bugreader.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.wat.bugreader.config.dbmigrations");
