(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('bugreaderApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-bugreaderApp-error');
                var entityKey = httpResponse.headers('X-bugreaderApp-params');
                if (errorHeader) {
